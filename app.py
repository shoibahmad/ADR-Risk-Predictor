...
def get_sample_data(sample_type):
    ...
    sample_patients = {
        ...
        'liver-disease': {
            ...
            'concomitant_drugs_count': 8, 'indication': 'Pain',
        ...
        'kidney-disease': {
            'name': 'Kidney Disease Patient - Chronic Renal Failure',
            'age': 68, 'sex': 'F', 'ethnicity': 'Black', 'height': 165, 'weight': 72, 'bmi': 26.4,
            'creatinine': 6.8, 'egfr': 15, 'ast_alt': 35, 'bilirubin': 1.2, 'albumin': 3.1,
            'hemoglobin': 7.2, 'hematocrit': 21.6, 'wbc_count': 8.5, 'platelet_count': 245, 'rbc_count': 2.8,
            'diabetes': 1, 'liver_disease': 0, 'ckd': 1, 'cardiac_disease': 1, 'hypertension': 1,
            'respiratory_disease': 0, 'neurological_disease': 0, 'autoimmune_disease': 0,
            'medication_name': 'Furosemide', 'index_drug_dose': 350, 'drug_interactions': 'Moderate',
            'concomitant_drugs_count': 15, 'indication': 'Cardiovascular',
            'cyp2c9': 'Intermediate', 'cyp2d6': 'PM', 'bp_systolic': 175, 'bp_diastolic': 98,
            'heart_rate': 95, 'time_since_start_days': 60, 'cyp_inhibitors_flag': 0,
            'qt_prolonging_flag': 1, 'hla_risk_allele_flag': 0, 'inpatient_flag': 1,
            'prior_adr_history': 1
        },
        'cardiac-patient': {
            ...
            'concomitant_drugs_count': 14, 'indication': 'Cardiovascular',
        ...
        'elderly-frail': {
            ...
            'concomitant_drugs_count': 22, 'indication': 'Cardiovascular',
        ...
        'cancer-patient': {
            ...
            'concomitant_drugs_count': 10, 'indication': 'Cancer',
        ...
        'pediatric-equivalent': {
            ...
            'concomitant_drugs_count': 2, 'indication': 'Pain',
